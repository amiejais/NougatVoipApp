...
public class NgnConfigurationEntry {
    ...
    //	Identity
    public static String DEFAULT_IDENTITY_DISPLAY_NAME = "Amie Jais";
    public static String DEFAULT_IDENTITY_IMPU = ""; //"sip:amiejais@sip2sip.info";
    public static String DEFAULT_IDENTITY_IMPI = "";//"amiejais";
    public static String DEFAULT_IDENTITY_PASSWORD = "";//"123456";

    // Network
    public static final int DEFAULT_NETWORK_REGISTRATION_TIMEOUT = 3000;
    public static final String DEFAULT_NETWORK_REALM = "sip2sip.info";
