...
public interface IScreenService extends INgnBaseService {
	...
	boolean show(Class<? extends AppCompatActivity> cls, String id);
	boolean show(AppCompatActivity cls, Fragment fragment, String id);
	boolean show(Class<? extends AppCompatActivity> cls);
