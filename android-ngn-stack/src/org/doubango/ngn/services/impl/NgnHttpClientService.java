...
public class NgnHttpClientService extends NgnBaseService implements INgnHttpClientService {
	...
	public boolean start() {
		...
		if(mClient == null){
			...
			final cz.msebera.android.httpclient.params.HttpParams params = new BasicHttpParams();
			cz.msebera.android.httpclient.params.HttpConnectionParams.setConnectionTimeout(params, sTimeoutConnection);
			cz.msebera.android.httpclient.params.HttpConnectionParams.setSoTimeout(params, sTimeoutSocket);
